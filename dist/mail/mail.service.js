...
class MailService {
    ...
    async enviarNuevoAnuncio(to, nombre, anuncio) {
...
<small>Publicado: {{fecha}}</small>`;
    ...
    renderTemplateConfirmacion(nombre, preferencias) {
        const tpl = `<h2>Hola {{nombre}},</h2>
